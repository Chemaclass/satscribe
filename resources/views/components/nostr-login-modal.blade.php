<div id="nostr-login-modal"
    ...
    class="fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-sm bg-black/40 dark:bg-black/60"
     style="display: none;"
     x-cloak>
    <div class="relative w-full max-w-md p-6 rounded-2xl shadow-2xl bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-gray-600"
        ...
        <div class="space-y-6">
            <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">
                    ...
                    <a href="https://getalby.com/products/browser-extension" target="_blank" class="underline text-blue-600 dark:text-blue-400">Alby</a>
                    or
                    <a href="https://github.com/fiatjaf/nos2x" target="_blank" class="underline text-blue-600 dark:text-blue-400">nos2x</a>
                </p>
            ...
            <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">{{ __('Less secure. Enter a private key.') }}</p>
                <input type="password" x-model="privKey"
                       class="w-full p-2 text-sm bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 rounded mb-2"
                       placeholder="nsec..." />
            ...
            <button @click="closeModal"
                    class="w-full bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-100 px-4 py-2 rounded">{{ __('Cancel') }}</button>
        </div>
    </div>
</div>
<script>
